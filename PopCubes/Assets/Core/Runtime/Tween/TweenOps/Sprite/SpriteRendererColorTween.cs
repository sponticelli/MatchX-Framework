...
namespace ZigZaggle.Core.Tweening
{
    internal class SpriteRendererColorTween : TweenOperation
    {
        ...
        public SpriteRendererColorTween(SpriteRenderer target, Color endValue, float duration, float delay,
            bool obeyTimescale, AnimationCurve curve, Tween.TweenLoopType tweenLoop, Action startCallback,
            Action completeCallback)
        {
            SetCommonProperties(Tween.TweenType.SpriteRendererColor, target.GetInstanceID(), duration, delay, obeyTimescale,
