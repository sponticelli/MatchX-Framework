...
namespace ZigZaggle.Core.Tweening
{
    internal class RawImageColorTween : TweenOperation
    {
        ...
        public RawImageColorTween(RawImage target, Color endValue, float duration, float delay, bool obeyTimescale,
            AnimationCurve curve, Tween.TweenLoopType tweenLoop, Action startCallback, Action completeCallback)
        {
            SetCommonProperties(Tween.TweenType.RawImageColor, target.GetInstanceID(), duration, delay, obeyTimescale, curve,
